...
const STORIES = [
  ...
  // ============ 第一章 第二节：大弟子重伤 ============
  {
    ...
    body:"清晨，演武场。陈渊倒在血泊里——胸口一道剑伤，气若游丝。",
    quote:"他若倒了，下一个就是我们。",
    scenes:[
      ...
      { bg:"sc_battle", speaker:"d_chenyuan", name:"陈 渊（昏 迷）",
        text:`你蹲下身，从陈渊怀里取出一封半写完的信。\n\n上面只有一行墨：\n\n「师妹，今夜若我未归——\n请将那封我藏在藏经阁的信，烧了。」`, },
      { bg:"sc_temple", speaker:"d_lingxue", name:"凌 雪",
        text:`「藏经阁……\n（她声音很轻）\n师兄昏迷前最后一笔，是写给我的。\n\n掌门，让我去找那封信。\n请允许我一夜不眠。」`, },
      { bg:"sc_temple", speaker:"d_master", name:"祖 师",
        text:`「孩子。\n\n陈渊已抬入丹房——\n但要醒来，至少需三日静养。\n这期间他不能修炼，不能出战。\n\n眼下这一桩，怎么处置都是错。\n选哪条，看你的眼光。」`, },
    ...
    choices:[
      { label:"立刻报官，与雷霆门决裂", b:"激进 · 但确立正派姿态", r:{ flag:"war_thunder", rep:30, woundChenyuan:true },
        requireFlag:"investigated_jade", lockHint:"先去名录翻陈渊档案，再细看玉碎来历" },
      { label:"假意不知，秘密追查", b:"暗查 · 隐忍数月", r:{ flag:"secret_invest", exp:50, woundChenyuan:true },
        requireFlag:"investigated_yard", lockHint:"先派一人探演武场，可寻得线索" },
      { label:"将玉碎送回雷霆门", b:"以礼还礼，赌对方的真意", r:{ flag:"return_jade", luck:2, giveItem:"sc_thunder", woundChenyuan:true } },
    ],
  },
